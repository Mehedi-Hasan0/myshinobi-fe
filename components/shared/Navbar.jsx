...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="container-padding lg:block py-4 2xl:py-8 hidden sticky top-0 z-40 bg-[#0e0c15]">
      ...
      {/* for mobile */}
      <nav className="block lg:hidden container-padding py-2 sticky top-0 bg-[#0e0c15] z-40">
